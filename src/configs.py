configs = {
    ...
    #        "enforcing": {"norm_set": 6, "strategy": "guardrail | fixing | optimal_reward_shaping | full_reward_shaping", "phase": "during_training | after_training", "enforcing_horizon": 4},
    #        },
    ...
    "T1": {"repetitions": 3, "episodes": 20, "max_steps": 30,
           ...
           "planning": {"delta": 0.3, "strategy": "delta_greedy_planning", "planning_horizon": 12},
           "deontic": {"norm_set": 4, "evaluation_function": 3},
           "enforcing": {"norm_set": 6, "strategy": "guardrail | fixing", "enforcing_horizon": 3, "phase": "after_training"},
           },
