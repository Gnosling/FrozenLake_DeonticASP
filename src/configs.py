configs = {
    ...
    #        "planning": {"norm_set": 7, "delta": 0.5, "strategy": "no_planning | full_planning | plan_for_new_states | delta_greedy_planning | delta_decaying_planning", "planning_horizon": 14},
    #        "deontic": {"norm_set": 8, "evaluation_function": 3},
    #        "enforcing": {"norm_set": 6, "strategy": "guardrail | fixing | optimal_reward_shaping | full_reward_shaping", "phase": "during_training | after_training", "enforcing_horizon": 4 (no use in guardral; in fixing is len of checked path and also len of fixed path; in reward-shaping defines number of shaping steps)},
    #        },

    "T1": {"repetitions": 3, "episodes": 20, "max_steps": 30,
           "frozenlake": {"name": "FrozenLake4x4_A", "traverser_path": "4x4_A", "slippery": True},
           "learning": {"norm_set": 7, "epsilon": 0.3, "initialisation": "zero", "reversed_q_learning": True, "discount": 0.95, "learning_rate": 0.6, "learning_rate_strategy": "exponential_decay", "learning_decay_rate": 0.005},
           "planning": {"norm_set": 7, "delta": 0.95, "strategy": "delta_greedy_planning", "planning_horizon": 10, "reward_set" : 2},
           "deontic": {"norm_set": 8, "evaluation_function": 5},
           "enforcing": {"norm_set": 13, "strategy": "fixing", "phase": "during_training", "enforcing_horizon": 5},
           },
