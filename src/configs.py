configs = {
    "T1": {"repetitions": 20, "episodes": 50, "max_steps": 50,
             "learning": {"discount": 0.9, "learning_rate": 0.3, "learning_rate_strategy": "constant", "learning_decay_rate": None, "initialisation": "safe", "reversed_q_learning": True},
             "frozenlake": {"name": "FrozenLake4x4_A", "slippery": True, "traverser_path": "4x4_A"},
             "planning" : {"policy": "planning", "epsilon": 0.05, "planning_strategy": "plan_for_new_states", "planning_horizon": 12},
